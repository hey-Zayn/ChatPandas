        ...
        <section className="w-full text-white body-font">
          <div className="container mx-auto flex gap-10 max-sm:gap-10 px-5 max-sm:px-2  py-24 md:flex-row flex-col items-center">
            ...
            <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center max-sm:text-left max-sm:px-8">
              ...
              Daily Habits is a mobile application focused on habit-building and personal growth. The app helps users track daily routines, set reminders, and visualize progress. With an intuitive user interface, its designed to make habit formation a fun and engaging process.The application is built using React Native, ensuring compatibility with both iOS and Android platforms. Customizable themes and notifications make it easy for users to personalize their experience. The apps lightweight design keeps performance fast, ensuring users remain motivated throughout their journey of self-improvement.
              <br />
              <br />
              Thanks a lot, Daily Habits, for choosing us.
              </p>
