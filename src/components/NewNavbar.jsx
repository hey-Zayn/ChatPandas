        ...
        <NavigationMenuList>
          <NavigationMenuItem>
            ...
            <NavigationMenuContent className={` `}>
              <ul className="grid gap-3 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr] text-black">
                <li className="row-span-3 bg-transparent text-black">
                  <NavigationMenuLink asChild>
                    ...
                    >
                      ...
                      <div className="mb-2 mt-4 text-lg font-medium">SEO</div>
