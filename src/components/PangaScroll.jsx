    ...
    <>
      <div className="bg-[rgb(28,28,28)]">
        ...
        >
          ...
          />
          <p className="absolute text-center text-white bottom-[5%] xl:bottom-[12%] md:bottom-[17%] lg:bottom-[13%] 2xl:bottom-[10%] right-[30%] text-xl sm:text-2xl md:text-3xl lg:text-4xl 2xl:text-5xl font-medium w-[43%] xl:w-[43%] lg:w-[48%] 2xl:w-[50%]">
